(function (angular, undefined) {
	...
	myApp.directive('customSelect', ['$parse', '$compile', '$timeout', 'customSelectDefaults', function ($parse, $compile, $timeout, baseOptions) {
	...
	myApp.directive('stopPropagation', function () {
		return {
			restrict: 'A',
